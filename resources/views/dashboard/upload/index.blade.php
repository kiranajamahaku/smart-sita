        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="row">
                <h3 class="font-weight-bold">Upload Persyaratan Sidang Akhir</h3>
              </div>
            </div>
          </div>
          <div class="row">		
                      ...
                      <tr>
                        <td>
                          <a href="#" data-target="#editDataModal" class="edit" data-toggle="modal" 
                            data-id="{{ $b->id }}" 
                            data-proposal="{{ $b->proposal }}"
                            data-laporan="{{ $b->laporan }}"
                            data-makalah="{{ $b->makalah }}"
                            data-filecoding="{{ $b->file_coding }}"
                            data-filedatabase="{{ $b->file_database }}">
                        ...
                        <td>
                            ...
                            <div style="margin-top: 5px;">
                              <a href="{{ route('upload.download', ['upload' => $b->id, 'file' => 'proposal']) }}">
                        ...
                        <td>
                            {{ $b->laporan }}
                            <div style="margin-top: 5px;">
                              <a href="{{ route('upload.download', ['upload' => $b->id, 'file' => 'laporan']) }}">
                                <small>DOWNLOAD</small>
                            </a>
                            </div>
                        </td>
                        <td>
                            {{ $b->makalah }}
                            <div style="margin-top: 5px;">
                              <a href="{{ route('upload.download', ['upload' => $b->id, 'file' => 'makalah']) }}">
                                <small>DOWNLOAD</small>
                            </a>
                            </div>
                        </td>
                        <td>
                            {{ $b->file_coding }}
                            <div style="margin-top: 5px;">
                              <a href="{{ route('upload.download', ['upload' => $b->id, 'file' => 'file_coding']) }}">
                                <small>DOWNLOAD</small>
                            </a>
                            </div>
                        </td>
                        <td>
                            {{ $b->file_database }}
                            <div style="margin-top: 5px;">
                              <a href="{{ route('upload.download', ['upload' => $b->id, 'file' => 'file_database']) }}">
                                <small>DOWNLOAD</small>
                            </a>
                            </div>
                        </td>
                  ...
                  <form action="/dashboard/upload" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">		
                      <div class="form-group">
                        ...
                        <input type="file" class="form-control-file" name="upload_proposal" required>
                      </div>			
                      <div class="form-group">
                        <label>Laporan Skripsi</label>
                        <input type="file" class="form-control-file" name="upload_laporan" required>
                      </div>			
                      <div class="form-group">
                        <label>Makalah</label>
                        <input type="file" class="form-control-file" name="upload_makalah" required>
                      </div>			
                      <div class="form-group">
                        <label>File Coding</label>
                        <input type="file" class="form-control-file" name="upload_file_coding" required>
                      </div>			
                      <div class="form-group">
                        <label>File Database</label>
                        <input type="file" class="form-control-file" name="upload_file_database" required>
                      </div>	
                    </div>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <form id="editForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                      <div class="alert alert-warning">Hanya isi file yang ingin diubah</div>	
                      <div class="form-group">
                        <label>Proposal</label>
                        <input type="file" class="form-control-file" name="upload_proposal" required>
                      </div>			
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      $('#editSubmitData').on('click', function (en) {
          en.preventDefault();
          var submitUrl = '/dashboard/upload/' + resourceId,
          form = $('#editForm'); 
