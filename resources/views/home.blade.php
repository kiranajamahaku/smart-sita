    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#team">Informasi</a></li>
    ...
    <section id="steps" class="steps">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up-right">
          ...
          <h3>Step-step Smart-SITA</h3>
          <p>Berikut adalah langkah-langkah dasar dalam penggunaan Smart-SITA. Untuk informasi lebih lanjut dapat melihat bagian Petunjuk.</p>
    ...
    <section id="petunjuk-sec" class="petunjuk-sec">
      <div class="container">
        <div class="row" data-aos="fade-up-left">
          ...
          <h3>Petunjuk</h3>
          <p>Petunjuk tambahan untuk user. Klik masing-masing 'Card' untuk melihat informasi.</p>

          <div class="cards-list">

            {{-- Manual Smart SITA --}}
            <div class="card 1" onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-black">
              <div class="card_image"> <img src="https://images.unsplash.com/photo-1535982330050-f1c2fb79ff78?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" /></div>
            ...
            <div class="card 2" onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-black">
              <div class="card_image">
                <img src="https://images.unsplash.com/photo-1514474959185-1472d4c4e0d4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80" />
              </div>
              <div class="card_title">
                <p>Reviewer</p>
              </div>
            ...
            <div class="card 3" onclick="document.getElementById('id03').style.display='block'" class="w3-button w3-black">
              <div class="card_image">
                <img src="https://images.unsplash.com/photo-1532073101218-8c90e03fbe68?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=388&q=80" />
              </div>
              <div class="card_title">
                <p>Pembimbing 1 & 2</p>
              </div>
            ...
            <div class="card 4" onclick="document.getElementById('id04').style.display='block'" class="w3-button w3-black">
              <div class="card_image">
                <img src="https://images.unsplash.com/photo-1501290836517-b22a21c522a4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80" />
              </div>
              <div class="card_title">
                <p>Penguji 1, 2 & 3</p>
              </div>
